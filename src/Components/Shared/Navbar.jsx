...
const Navbar = () => {
    ...
    <li><NavLink to={'/pagre-red'}  className={({isActive})=> `font-semibold mr-1 ${isActive ? "text-green-500 border-2 border-green-500" : "" }`}>Page To Read</NavLink></li>
    
    </>
    return (
        <div className="navbar bg-base-100 shadow-sm">
            <div className='navbar container w-[85%] mx-auto'>
            <div className="navbar-start">
                ...
                <a className=" text-xl">Book Vide</a>
            </div>
